...
String sql_parameter="update "+tableName+" set song_name='"+song_name+"',song_lyrics_author='"+song_lyrics_author+"',song_creation_time='"+song_creation_time+"',song_album='"+song_album+"',song_length='"+song_length+"',song_favorite='"+song_favorite+"',song_singer='"+song_singer+"'";
