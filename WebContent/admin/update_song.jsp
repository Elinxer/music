				...
				if (!myFile.isMissing())
					{
						...
						if(i==0){
							//文件的绝对路径
							String abs_path=w_path+song_trace1;
							out.println(abs_path);
							//删除原文件
							deleteFile(abs_path);
							//取得后缀名
							...
							//文件的绝对路径
							String abs_path=w_path+song_lyric1;
							out.println(abs_path);
							//删除原文件
							deleteFile(abs_path);
							//取得后缀名
							...
							stmt2.close();
								...
								//文件的绝对路径
								String abs_path=w_path+song_avatar1;
								out.println(abs_path);
								//删除原文件
								deleteFile(abs_path);
								//取得后缀名
								...
								//文件的绝对路径
								String abs_path=w_path+song_pictures1;
								out.println(abs_path);
								//删除原文件
								deleteFile(abs_path);
								//取得后缀名
