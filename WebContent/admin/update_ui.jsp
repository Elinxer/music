	...
	<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
		...
		<div class="main-content">
			...
			<table class="table table-bordered">
							<thead>
								<tr class="no-borders">
									<th class="text-center hidden-xs">歌曲ID</th>
									<th class="text-center hidden-xs">歌名</th>
									<th class="text-center hidden-xs">歌手</th>
									<th class="text-center hidden-xs">词曲作者</th>
									<th class="text-center hidden-xs">创作时间</th>
									<th class="text-center hidden-xs">时长</th>
									<th class="text-center hidden-xs">专辑</th>
									<th class="text-center hidden-xs">喜爱</th>
									<th class="text-center hidden-xs">歌曲文件</th>
									<th class="text-center hidden-xs">词曲文件</th>
									<th class="text-center hidden-xs">头像文件</th>
									<th class="text-center hidden-xs">图册文件</th>
