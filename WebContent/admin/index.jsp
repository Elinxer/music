...
<%  //session.putValue("ADMIN_AUTH_KEY", null); //清除session
	if (session.getAttribute("ADMIN_AUTH_KEY") == null) {
%><jsp:forward page="adminLogin.jsp" /><% } %>

<%

String meta_title = "控制面板";
...
>>>>>>> 528c3367ce272dc9b66c5775db4ab9263106a137
